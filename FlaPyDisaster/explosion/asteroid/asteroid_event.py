...
class AsteroidEvent:
    def __init__(self, diameter_m, angle_rad, init_velocity_mps, density_kgpm3, target_density_kgpm3, grid):
        ...
        self.ret_period_yr = astr_math.ReturnPeriodEarth(self.initial_energy_j)
    ...
    def get_overpressure(radius_gz_m):
        ...
        return expl_math.NewmarkOverpressure(airburst_energy_j, radius_gz_m)